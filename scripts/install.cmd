@echo off
:: ============================================
:: RoadCraft Head Tracking - Install
:: ============================================
...
:: --- CONFIG BLOCK ---
set "GAME_ID=roadcraft"
set "MOD_DISPLAY_NAME=RoadCraft Head Tracking"
set "MOD_DLLS=RoadCraftHeadTracking.asi"
set "MOD_INTERNAL_NAME=RoadCraftHeadTracking"
set "MOD_VERSION=0.0.0"
set "STATE_FILE=.headtracking-state.json"
set "FRAMEWORK_TYPE=ASILoader"
:: Filename the ASI loader DLL is renamed to: the import the game exe already
:: has. Roadcraft - Retail.exe imports DINPUT8.dll, so the loader takes that name and
...
:: Left empty. Roadcraft - Retail.exe is at root\bin\pc rather than the
