...
$anchorMatch = $lines | Select-String -SimpleMatch '- SHA-256:' | Select-Object -First 1
if (-not $anchorMatch) { throw "vendor README.md has no '- SHA-256:' line to anchor the DLL hash after." }
$anchor = $anchorMatch.LineNumber
